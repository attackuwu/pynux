...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/home/archuwu/Documents/pynux-workshop/kernel/usr/bin',
    'BINLIBDEST': '/home/archuwu/Documents/pynux-workshop/kernel/usr/lib/python3.15',
    'BLDLIBRARY': '-L. -lpython3.15',
    ...
    'CONFIG_ARGS': "'--prefix=/home/archuwu/Documents/pynux-workshop/kernel/usr' '--enable-shared' '--with-openssl-rpath=no' '--disable-test-modules'",
    'CONFINCLUDEDIR': '/home/archuwu/Documents/pynux-workshop/kernel/usr/include',
    'CONFINCLUDEPY': '/home/archuwu/Documents/pynux-workshop/kernel/usr/include/python3.15',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/home/archuwu/Documents/pynux-workshop/tools/python/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/home/archuwu/Documents/pynux-workshop/tools/python/lcov-report',
    ...
    'CXX': 'g++',
    'DESTDIRS': '/home/archuwu/Documents/pynux-workshop/kernel/usr /home/archuwu/Documents/pynux-workshop/kernel/usr/lib /home/archuwu/Documents/pynux-workshop/kernel/usr/lib/python3.15 /home/archuwu/Documents/pynux-workshop/kernel/usr/lib/python3.15/lib-dynload',
    'DESTLIB': '/home/archuwu/Documents/pynux-workshop/kernel/usr/lib/python3.15',
    'DESTPATH': '',
    'DESTSHARED': '/home/archuwu/Documents/pynux-workshop/kernel/usr/lib/python3.15/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/home/archuwu/Documents/pynux-workshop/kernel/usr/bin/python3.15',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'HAVE_EFFICIENT_BUILTIN_SHUFFLEVECTOR': 1,
    'HAVE_ENDIAN_H': 1,
    'HAVE_EPOLL': 1,
    ...
    'HAVE_STRUCT_STATX_STX_ATOMIC_WRITE_UNIT_MAX_OPT': 1,
    'HAVE_STRUCT_STATX_STX_ATOMIC_WRITE_UNIT_MIN': 1,
    'HAVE_STRUCT_STATX_STX_DIO_MEM_ALIGN': 1,
    'HAVE_STRUCT_STATX_STX_DIO_READ_OFFSET_ALIGN': 1,
    'HAVE_STRUCT_STATX_STX_MNT_ID': 1,
    'HAVE_STRUCT_STATX_STX_SUBVOL': 1,
    ...
    'INCLDIRSTOMAKE': '/home/archuwu/Documents/pynux-workshop/kernel/usr/include /home/archuwu/Documents/pynux-workshop/kernel/usr/include /home/archuwu/Documents/pynux-workshop/kernel/usr/include/python3.15 /home/archuwu/Documents/pynux-workshop/kernel/usr/include/python3.15',
    'INCLUDEDIR': '/home/archuwu/Documents/pynux-workshop/kernel/usr/include',
    'INCLUDEPY': '/home/archuwu/Documents/pynux-workshop/kernel/usr/include/python3.15',
    ...
    'INSTSONAME': 'libpython3.15.so.1.0',
    ...
    'LDFLAGS': '',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.15.so',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -shared',
    'LDVERSION': '3.15',
    'LIBC': '',
    'LIBDEST': '/home/archuwu/Documents/pynux-workshop/kernel/usr/lib/python3.15',
    'LIBDIR': '/home/archuwu/Documents/pynux-workshop/kernel/usr/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/home/archuwu/Documents/pynux-workshop/kernel/usr/lib/pkgconfig',
    'LIBPL': '/home/archuwu/Documents/pynux-workshop/kernel/usr/lib/python3.15/config-3.15-x86_64-linux-gnu',
    'LIBPYTHON': '',
    'LIBRARY': 'libpython3.15.a',
    'LIBRARY_DEPS': 'libpython3.15.a libpython3.15.so libpython3.so',
    'LIBRARY_OBJS': '\\',
    ...
    'LINK_PYTHON_DEPS': 'libpython3.15.a libpython3.15.so libpython3.so',
    'LINK_PYTHON_OBJS': '-L. -lpython3.15',
    'LIPO_32BIT_FLAGS': '',
    'LIPO_INTEL64_FLAGS': '',
    'LLVM_PROF_ERR': 'no',
    'LLVM_PROF_FILE': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/home/archuwu/Documents/pynux-workshop/kernel/usr/lib/python3.15',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/home/archuwu/Documents/pynux-workshop/kernel/usr/share/man',
    'MIMALLOC_HEADERS': '\\',
    'MKDIR_P': '/usr/bin/mkdir -p',
    'MODBUILT_NAMES': 'array  _bisect  _csv  _heapq  _json  _lsprof  _math_integer  _pickle  _queue  _random  _remote_debugging  _struct  _interpreters  _interpchannels  _interpqueues  _zoneinfo  math  cmath  _statistics  _decimal  binascii  _bz2  _lzma  _zstd  zlib  _dbm  _gdbm  readline  _md5  _sha1  _sha2  _sha3  _blake2  _hmac  pyexpat  _elementtree  _codecs_cn  _codecs_hk  _codecs_iso2022  _codecs_jp  _codecs_kr  _codecs_tw  _multibytecodec  unicodedata  fcntl  grp  mmap  _posixsubprocess  resource  select  _socket  syslog  termios  _posixshmem  _multiprocessing  _ctypes  _curses  _curses_panel  _sqlite3  _ssl  _hashlib  _uuid  _asyncio  atexit  faulthandler  posix  _signal  _tracemalloc  _suggestions  _datetime  _codecs  _collections  errno  _io  itertools  _sre  _sysconfig  _thread  time  _types  _typing  _weakref  _abc  _functools  _locale  _opcode  _operator  _stat  _symtable  pwd',
    'MODDISABLED_NAMES': '',
    'MODLIBS': '-lm',
    ...
    'MODSHARED_NAMES': 'array _bisect _csv _heapq _json _lsprof _math_integer _pickle _queue _random _remote_debugging _struct _interpreters _interpchannels _interpqueues _zoneinfo math cmath _statistics _decimal binascii _bz2 _lzma _zstd zlib _dbm _gdbm readline _md5 _sha1 _sha2 _sha3 _blake2 _hmac pyexpat _elementtree _codecs_cn _codecs_hk _codecs_iso2022 _codecs_jp _codecs_kr _codecs_tw _multibytecodec unicodedata fcntl grp mmap _posixsubprocess resource select _socket syslog termios _posixshmem _multiprocessing _ctypes _curses _curses_panel _sqlite3 _ssl _hashlib _uuid',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '',
    ...
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC',
    'PY_SUPPORT_TIER': 1,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'RESSRCDIR': '',
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'LD_LIBRARY_PATH=/home/archuwu/Documents/pynux-workshop/tools/python',
    'SCRIPTDIR': '/home/archuwu/Documents/pynux-workshop/kernel/usr/lib',
    'SCRIPT_IDLE': 'build/scripts-3.15/idle3.15',
    'SCRIPT_PYDOC': 'build/scripts-3.15/pydoc3.15',
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-315-x86_64-linux-gnu.so Modules/_bisect.cpython-315-x86_64-linux-gnu.so Modules/_csv.cpython-315-x86_64-linux-gnu.so Modules/_heapq.cpython-315-x86_64-linux-gnu.so Modules/_json.cpython-315-x86_64-linux-gnu.so Modules/_lsprof.cpython-315-x86_64-linux-gnu.so Modules/_math_integer.cpython-315-x86_64-linux-gnu.so Modules/_pickle.cpython-315-x86_64-linux-gnu.so Modules/_queue.cpython-315-x86_64-linux-gnu.so Modules/_random.cpython-315-x86_64-linux-gnu.so Modules/_remote_debugging.cpython-315-x86_64-linux-gnu.so Modules/_struct.cpython-315-x86_64-linux-gnu.so Modules/_interpreters.cpython-315-x86_64-linux-gnu.so Modules/_interpchannels.cpython-315-x86_64-linux-gnu.so Modules/_interpqueues.cpython-315-x86_64-linux-gnu.so Modules/_zoneinfo.cpython-315-x86_64-linux-gnu.so Modules/math.cpython-315-x86_64-linux-gnu.so Modules/cmath.cpython-315-x86_64-linux-gnu.so Modules/_statistics.cpython-315-x86_64-linux-gnu.so Modules/_decimal.cpython-315-x86_64-linux-gnu.so Modules/binascii.cpython-315-x86_64-linux-gnu.so Modules/_bz2.cpython-315-x86_64-linux-gnu.so Modules/_lzma.cpython-315-x86_64-linux-gnu.so Modules/_zstd.cpython-315-x86_64-linux-gnu.so Modules/zlib.cpython-315-x86_64-linux-gnu.so Modules/_dbm.cpython-315-x86_64-linux-gnu.so Modules/_gdbm.cpython-315-x86_64-linux-gnu.so Modules/readline.cpython-315-x86_64-linux-gnu.so Modules/_md5.cpython-315-x86_64-linux-gnu.so Modules/_sha1.cpython-315-x86_64-linux-gnu.so Modules/_sha2.cpython-315-x86_64-linux-gnu.so Modules/_sha3.cpython-315-x86_64-linux-gnu.so Modules/_blake2.cpython-315-x86_64-linux-gnu.so Modules/_hmac.cpython-315-x86_64-linux-gnu.so Modules/pyexpat.cpython-315-x86_64-linux-gnu.so Modules/_elementtree.cpython-315-x86_64-linux-gnu.so Modules/_codecs_cn.cpython-315-x86_64-linux-gnu.so Modules/_codecs_hk.cpython-315-x86_64-linux-gnu.so Modules/_codecs_iso2022.cpython-315-x86_64-linux-gnu.so Modules/_codecs_jp.cpython-315-x86_64-linux-gnu.so Modules/_codecs_kr.cpython-315-x86_64-linux-gnu.so Modules/_codecs_tw.cpython-315-x86_64-linux-gnu.so Modules/_multibytecodec.cpython-315-x86_64-linux-gnu.so Modules/unicodedata.cpython-315-x86_64-linux-gnu.so Modules/fcntl.cpython-315-x86_64-linux-gnu.so Modules/grp.cpython-315-x86_64-linux-gnu.so Modules/mmap.cpython-315-x86_64-linux-gnu.so Modules/_posixsubprocess.cpython-315-x86_64-linux-gnu.so Modules/resource.cpython-315-x86_64-linux-gnu.so Modules/select.cpython-315-x86_64-linux-gnu.so Modules/_socket.cpython-315-x86_64-linux-gnu.so Modules/syslog.cpython-315-x86_64-linux-gnu.so Modules/termios.cpython-315-x86_64-linux-gnu.so Modules/_posixshmem.cpython-315-x86_64-linux-gnu.so Modules/_multiprocessing.cpython-315-x86_64-linux-gnu.so Modules/_ctypes.cpython-315-x86_64-linux-gnu.so Modules/_curses.cpython-315-x86_64-linux-gnu.so Modules/_curses_panel.cpython-315-x86_64-linux-gnu.so Modules/_sqlite3.cpython-315-x86_64-linux-gnu.so Modules/_ssl.cpython-315-x86_64-linux-gnu.so Modules/_hashlib.cpython-315-x86_64-linux-gnu.so Modules/_uuid.cpython-315-x86_64-linux-gnu.so',
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl',
    'SHLIB_SUFFIX': '.so',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'LD_LIBRARY_PATH=/home/archuwu/Documents/pynux-workshop/tools/python ./python -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'LD_LIBRARY_PATH=/home/archuwu/Documents/pynux-workshop/tools/python ./python -E -m test',
    ...
    'abs_builddir': '/home/archuwu/Documents/pynux-workshop/tools/python',
    'abs_srcdir': '/home/archuwu/Documents/pynux-workshop/tools/python',
    'datarootdir': '/home/archuwu/Documents/pynux-workshop/kernel/usr/share',
    'exec_prefix': '/home/archuwu/Documents/pynux-workshop/kernel/usr',
    'host_exec_prefix': '/home/archuwu/Documents/pynux-workshop/kernel/usr',
    'host_prefix': '/home/archuwu/Documents/pynux-workshop/kernel/usr',
    'prefix': '/home/archuwu/Documents/pynux-workshop/kernel/usr',
    'srcdir': '.',
}
